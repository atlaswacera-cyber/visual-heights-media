const services = [
  ...
  { number: "04", title: "Digital", subtitle: "Built to be experienced.", description: "Websites, launch pages, and early app experiences shaped with the same cinematic, brand-first point of view." },
];
