export function Hero() {
  return (
    <section className="hero" aria-labelledby="hero-title">
      ...
      <div className="hero__visual" aria-hidden="true"><div className="hero-mark-crop"><img src="/vhm-mark.png" alt="" /></div><span className="hero__visual-label">Est. 2026 / VHM</span></div>
